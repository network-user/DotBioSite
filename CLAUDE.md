...
- Глобальные изменения функционала (команды, модули, проекты-кейсы, зависимости, архитектура, runtime) → обнови README + AGENTS.md тем же скиллом (включая пересчёт LoC)
